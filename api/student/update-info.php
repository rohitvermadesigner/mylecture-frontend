...
if (count($error_msgs) == 0) {
    ...
    if ($token_details['status'] == 'success') {
        ...
        if(isset($post_data->info) && !empty($post_data->info)){
            $basic_info = isset($post_data->info) ? $post_data->info : array();
            update_student_info($student_id, $basic_info, $db);
            ...
            array_push($error_msgs, "info key required");
        }
    } else {
