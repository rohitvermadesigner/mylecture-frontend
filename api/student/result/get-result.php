            ...
            if (isset($_GET['type']) && !empty($_GET['type'])) {
                if ($_GET['type'] == 'topic-simulator' || $_GET['type'] == 'self-assessor' || $_GET['type'] == 'admin-assigned') {
                    ...
                    if ($_GET['type'] == 'topic-simulator') {
                        ...
                        $test_result_detail = "topic_simulator_test_result_detail";
                        ...
                        $test_result_detail = "self_assessor_test_result_detail";
                    ...
                    $query_result_data = "SELECT * FROM $test_result_table 
                                WHERE id = '$result_id' AND 
                    ...
                    array_push($error_msgs, "Test should be 'topic-simulator' or 'self-assessor' or 'admin-assigned'");
                }
            } else {
