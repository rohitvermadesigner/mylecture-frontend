...
if (count($error_msgs) == 0) {
    ...
    if ($token_details['status'] == 'success') {
        ...
        if (!empty($post_data->phase_id) && !empty($post_data->name)) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $query = "INSERT INTO subject (name, phase_id, created_by, created_at) VALUES ('$subject_name', '$phase_id', '$admin_id', '$current_date')";
                $result = mysqli_query($db, $query);
            ...
            array_push($error_msgs, "Phase id and subject name should not be empty.");
        }
    } else {
