        ...
        <div class="dashboard-container">
            ...
            <div class="dashboard-title">
                <div class="overflow-hidden">
                    <h1 class="float-left">Topic Simulator Report</h1>
                </div>
            </div>
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $.each(result.result, function(key, value) {
                        ...
                        trHTML +=
                            '<tr><td>' + index++ +
                            '</td><td><a class="font-weight-bold" href="topic-simulator-report-result.php?test_id=' + value.id + '&type=topic-simulator">' + value.name +
