        ...
        <div class="dashboard-container">
            ...
            <div class="dashboard-title">
                <div class="overflow-hidden">
                    <h1 class="float-left">Topic Simulator</h1>
                </div>
            </div>

            <ul class="breadcrumb">
                <li><a href="dashboard.php">Dashboard</a></li>
                <li>Topic Simulator</li>
            </ul>
        ...
        $(function() {
            ...
            if (token) {
                ...
                let loadTests = function(page_no, page_count) {
                    ...
                    let url = `${base_url}/student/topic-simulator/list.php`;
                    $('#testData tbody').html('');
                ...
                $('body').on('click', '.remove-test', function() {
                    ...
                    if (status == true) {
                        ...
                        $.ajax({
                            url: base_url + '/student/topic-simulator/delete.php',
                            type: 'POST',
                            dataType: 'JSON',
                ...
                $('body').on('click', '.remove-all-test', function() {
                    ...
                    if (status == true) {
                        ...
                        $.ajax({
                            url: base_url + '/student/topic-simulator/delete-multiple.php',
                            type: 'POST',
                            dataType: 'JSON',
                            data: JSON.stringify(removeTest),
                            success: function(response) {
