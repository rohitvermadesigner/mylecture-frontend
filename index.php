...
<body>
    ...
    <section class="slide-section">
        <div id="mainSlide" class="carousel slide" data-ride="carousel">
            ...
            <a class="carousel-control-next" href="#mainSlide" data-slide="next">
    ...
    <div class="demo-classes-section">
        <div class="container">
            <div class="row">
                <div class=" col-md-6">
                    <div class="video">
                        <img src="assets/images/video-thumb.jpg" class="img-fluid" alt="" />
                        <!-- <div class="video-container ">
                            <iframe src="https://www.youtube.com/embed/q7LTDVsf_kA?autoplay=1&loop=1&playlist=q7LTDVsf_kA&mute=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div> -->
                    </div>
                </div>
                <div class="col-md-6">
                    <h2 class="title-primary">Demo <span> Classes</span></h2>
                    <p class="pt-2">
            ...
            <!-- <div class="demo-class-box">
                <div class="row">
                    <div class="col-md-8">
                        <img src="assets/images/video-thumb.jpg" class="img-fluid" alt="">
                         <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/8EnanQR5oec"></iframe>
                        </div> 
        </div>
        <div class="col-md-4">
            <div class="demo-class-box-right-list">
                <ul>
                    <li class="row">
                        <div class="col-4">
                         <div class="embed-responsive embed-responsive-16by9">
        ...
        <div class="col-8 pl-0">
            <h4>Chemistry (States of Matter)</h4>
            <p>By Harishwar Reddy</p>
        </div>
        </li>
        <li class="row">
            <div class="col-4">
    ...
    <!-- demo-classes-section ends here -->

    <!-- talktoexpert-section begin here -->
    <div class="talktoexpert-section">
        <form>
            <div class="container">
                <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="career-box career-box-1">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="assets/images/mock-test-img1.png" class="img-fluid" alt="">
                            </div>
                            <div class="col-md-6">
                                <ul>
                                    <li>
                ...
                <div class="col-md-6">
                    <div class="career-box career-box-2">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="assets/images/mock-test-img2.png" class="img-fluid" alt="">
                            </div>
                            <div class="col-md-6">
                                <ul>
                                    <li>
                ...
                <div class="col-md-6">
                    <div class="career-box career-box-3">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="assets/images/mock-test-img3.png" class="img-fluid" alt="">
                            </div>
                            <div class="col-md-6">
                                <ul>
                                    <li>
                ...
                <div class="col-md-6">
                    <div class="career-box career-box-4">
                        <div class="row">
                            <div class="col-md-6">
                                <img src="assets/images/mock-test-img4.png" class="img-fluid" alt="">
                            </div>
                            <div class="col-md-6">
                                <ul>
                                    <li>
    ...
    <!-- online-exam begin here -->
    <section class="online-exam">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5">
                    <img src="assets/images/online-exam.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-md-2">
                    <h2>Online Exam</h2>
                    <ul>
    ...
    <!-- online-exam ends here -->
    <!-- get-app-section begin here -->
    <section class="get-app-section">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <img src="assets/images/get-app.png" alt="" class="img-fluid">
                </div>
                <div class="col-md-8">
