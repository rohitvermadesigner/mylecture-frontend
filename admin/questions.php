                                ...
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <ul class="filter-list">
                                            ...
                                            <li>
                                                <input type="search" class="form-control" id="question-filter"
                                                    placeholder="Type Question..">
                                            </li>
                                            <li>
                                                <button class="btn btn-primary" id="search-btn">Search</button>
                                                <button class="btn btn-danger display-none"
                                            ...
                                            <ul class="top-right-btn-list">
                                                <li>
                                                    <button class="btn btn-primary display-none"
                                                        id="moveBtn">Move</button>
                                                </li>
                                                <li>
                                                    <a href="create-question.php" class="btn btn-primary"><i
                                    ...
                                    <div class="ibox-content">
                                        <div class="table-responsive mt-3">
                                            ...
                                            <div class="table-bottom" style="position: relative;">
                                                ...
                                                <select class="form-control float-right" id="rowSorting"
                                                    style="width: 75px; position: absolute; right: 0; top: 0;">
                ...
                <div class="modal-body">
                    <form id="moveForm">
                        <ul class="filter-list">
                            ...
                            <li>
                                <select class="form-control chapter-filter" name="topic_name">
                                    <option value="">-- Select Topic --</option>
                                </select>
                            </li>
                            <li>
        ...
        if (token) {
            ...
            var getAllSubjects = function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        allSubjects.sort((a, b) => a.name.toLowerCase() < b.name.toLowerCase() ?
                            -1 : 1);
            ...
            $('.subject-filter').change(function(val) {
                ...
                if (subject) {
                    allSubjects.forEach(val => {
                        if (val.id == subject) {
                            $this.parents('ul').find('.chapter-filter').html('');
                            $this.parents('ul').find('.chapter-filter').append(
                                `<option value="">-- Select Topic --</option>`);
